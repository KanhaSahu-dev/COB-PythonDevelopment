# Welcome to python project:- Dashboard creation using python library matplotlib.
# Here i have used tkinter matplotlib to visualise a sample data 
# The visualisation are pie chart bar graph etc...
...
plt.rcParams["axes.prop_cycle"] = plt.cycler(
    color=["brown", "red", "green", "yellow", "black"])
...
ax3.pie(product_data.values(), labels=product_data.keys(), autopct='%10.1f%%')
